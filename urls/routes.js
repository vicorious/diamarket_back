...
const { routesOrderServiceApp, routesOrderServiceWeb } = require('./orderService')
...
const { routesAppCity, routesWebCity } = require('./city')
const { routesAppCountry, routesWebCountry } = require('./country')
const { routesAppState, routesWebState } = require('./state')
const { routeSwaggerWeb } = require('./swagger')
const { routerCalificationApp } = require('./calificationRoute')
...
routes.use('/app/orderservice', routesOrderServiceApp)
routes.use('/app/city', routesAppCity)
routes.use('/app/country', routesAppCountry)
routes.use('/app/state', routesAppState)
routes.use('/app/calification', routerCalificationApp)
...
routes.use('/web/city', routesWebCity)
routes.use('/web/country', routesWebCountry)
routes.use('/web/state', routesWebState)
