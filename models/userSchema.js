...
class User extends Base {
  constructor () {
    ...
    this.fields = '_id isActive dateCreate logs cards directions userList order name identification email cellPhone rol supermarketFavorite  birthday credits image'
    this.populate = [{
